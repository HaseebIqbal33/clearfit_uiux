...
const Footer = () => {
  ...
  return (
    <div className="bg-primary">
      <div className="container mx-auto flex justify-between flex-col lg:flex-row  p-14 sm:p-0 bg-primary gap-10">
        ...
        <div className="lg:w-1/3 w-full  lg:p-10 p-2">
          <div className="flex flex-col gap-10">
            ...
            <div
              className="flex flex-wrap justify-around sm:w-80 w-72 gap-0"
              style={{ lineHeight: "50px" }}
            >
              {links.map((item, index) => {
                return (
                  <a
                    className=" w-28 sm:w-40 text-white cursor-pointer"
                    key={index}
                  >
                    {item}
                  </a>
